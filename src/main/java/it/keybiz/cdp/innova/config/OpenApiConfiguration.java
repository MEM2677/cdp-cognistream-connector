...
public class OpenApiConfiguration {
    ...
    public Docket frontApi() {
        ApiInfo apiInfo = new ApiInfoBuilder()
            .title("CDP Innova Front Office APIs")
            .build();

        return new Docket(DocumentationType.OAS_30)
            .groupName("cdp-innova-front-office")
            .apiInfo(apiInfo)
            .select()
            .apis(RequestHandlerSelectors.basePackage("it.keybiz.cdp.innova.web.rest.front"))
    ...
    public Docket backApi() {
        ApiInfo apiInfo = new ApiInfoBuilder()
            .title("CDP Innova Back Office APIs")
            .build();

        return new Docket(DocumentationType.OAS_30)
            .groupName("cdp-innova-back-office")
            .apiInfo(apiInfo)
            .select()
            .apis(RequestHandlerSelectors.basePackage("it.keybiz.cdp.innova.web.rest.back"))
            .paths(PathSelectors.any())
            .build()
            .securitySchemes((getSecuritySchemes()))
            .securityContexts(securityContext());
